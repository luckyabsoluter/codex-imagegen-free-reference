...
Set `SKILL_ROOT` to the resolved absolute path of this skill folder, then derive a stable path to the skill CLI:

```
export SKILL_ROOT="<absolute path to this skill folder>"
export IMAGE_GEN="$SKILL_ROOT/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `SKILL_ROOT/scripts/remove_chroma_key.py`
