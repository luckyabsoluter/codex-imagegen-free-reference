...
export IMAGE_GEN="$CODEX_HOME/skills/codex-imagegen-free-reference/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `$CODEX_HOME/skills/codex-imagegen-free-reference/scripts/remove_chroma_key.py`
